...
A modern, user-friendly GUI application for downloading and converting audio from YouTube and other platforms. Built with Python and PyQt6.

![Application Screenshot](screenshots/app.png)  <!-- You can add this later -->

## Features

- Clean, macOS-style interface
- Multiple audio format support (MP3, M4A, WAV, FLAC, OPUS)
- Customizable quality settings (320kbps to 96kbps)
...
```bash
git clone https://github.com/andyckt/Converter.git
cd Converter
```
...
5. Click "Convert" to start the download and conversion process

### Keyboard Shortcuts

- `Enter`: Start conversion
- `Ctrl+O`: Browse output directory
